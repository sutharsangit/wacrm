  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-zinc-950 border border-zinc-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
        ...
        <p className="text-xs text-zinc-400 mt-1">Log in to manage your qualified WhatsApp leads.</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
          <div>
            ...
            <input
              ...
              className={`w-full bg-zinc-900 border ${errors.email ? 'border-destructive' : 'border-zinc-800'} rounded-lg px-3.5 py-2.5 text-xs text-white focus:outline-none focus:border-primary transition-colors`}
              {...register('email')}
            />
            {errors.email && (
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                disabled={loading}
                placeholder="••••••"
                className={`w-full bg-zinc-900 border ${errors.password ? 'border-destructive' : 'border-zinc-800'} rounded-lg pl-3.5 pr-10 py-2.5 text-xs text-white focus:outline-none focus:border-primary transition-colors`}
                {...register('password')}
              />
              <button
                type="button"
