...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-primary selection:text-white">
      {/* Header / Navbar */}
      <header className="border-b border-zinc-800/80 bg-black/80 backdrop-blur-md fixed top-0 w-full z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link 
              href="/register" 
              className="bg-primary hover:bg-primary/90 text-white text-xs font-semibold px-4 py-2 rounded-lg transition-colors shadow-lg shadow-primary/20"
            >
              Get Started
            </Link>
          </div>
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 overflow-hidden bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-zinc-900/50 via-black to-black">
        {/* Glow Element */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/register" 
              className="w-full sm:w-auto bg-primary hover:bg-primary/95 text-white font-medium px-8 py-3 rounded-lg flex items-center justify-center gap-2 group transition-all shadow-xl shadow-primary/20"
            >
            ...
            <button 
              ...
              className="w-full sm:w-auto border border-zinc-700 hover:border-zinc-500 bg-zinc-900/30 hover:bg-zinc-900/60 text-white font-medium px-8 py-3 rounded-lg flex items-center justify-center gap-2 transition-all"
            >
          ...
          {/* SaaS Mockup Preview */}
          <div className="mt-16 border border-zinc-800 rounded-2xl bg-zinc-950/60 p-2 max-w-5xl mx-auto shadow-2xl relative">
            {/* Top Bar Circles */}
            <div className="flex items-center gap-1.5 px-3 py-2 border-b border-zinc-800">
              <div className="w-3 h-3 rounded-full bg-red-500/80" />
              <div className="w-3 h-3 rounded-full bg-yellow-500/80" />
              <div className="w-3 h-3 rounded-full bg-green-500/80" />
              <div className="text-[10px] text-zinc-600 font-mono ml-4 truncate">https://app.whatsappcrm.io/dashboard</div>
            </div>
            
            {/* Layout simulation grid */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 p-4 bg-black/40 text-left">
              {/* Left pane stats */}
              <div className="border border-zinc-800/80 rounded-xl p-4 bg-zinc-900/20 backdrop-blur">
                <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold block">Total Active Leads</span>
                <span className="text-2xl font-bold text-white block mt-1">830</span>
                ...
                <span className="text-[10px] text-zinc-500 uppercase tracking-widest font-semibold block">Qualified Rate</span>
              ...
              <div className="md:col-span-2 border border-zinc-800/80 rounded-xl p-4 bg-zinc-900/20 backdrop-blur relative overflow-hidden">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex flex-col items-end">
                    <div className="bg-primary text-white p-2.5 rounded-2xl rounded-tr-none max-w-[85%]">
                      Are you looking to purchase commercial office space within the next 30 days?
                    </div>
                    <span className="text-[9px] text-zinc-500 mt-1">AI Copilot • 11:32 AM</span>
                  </div>
                  <div className="flex flex-col items-start">
                    <div className="bg-zinc-800/80 text-zinc-100 p-2.5 rounded-2xl rounded-tl-none max-w-[85%]">
                      Yes, looking for a workspace downtown. Budget is around $80k downpayment.
                    </div>
                    <span className="text-[9px] text-zinc-500 mt-1">David Miller (Lead) • 11:33 AM</span>
                  </div>
                </div>

                {/* Score popover */}
                <div className="absolute right-4 bottom-4 bg-zinc-950 border border-primary/50 text-primary text-[10px] px-2.5 py-1.5 rounded-full font-bold flex items-center gap-1 shadow-lg shadow-primary/20">
              ...
              <div className="border border-zinc-800/80 rounded-xl p-4 bg-zinc-900/20 backdrop-blur space-y-3">
                <span className="text-xs font-semibold text-zinc-400 block border-b border-zinc-800/80 pb-1.5">Lead Funnel Stage</span>
                
                <div className="space-y-2">
                  <div className="bg-zinc-900 border border-zinc-800 p-2 rounded-lg text-xs flex justify-between items-center opacity-40">
                    <span className="font-medium text-zinc-500">New Lead</span>
                    <span className="text-[10px] bg-zinc-800 px-1.5 py-0.5 rounded text-zinc-500">20%</span>
                  </div>
                  <div className="bg-primary/5 border border-primary/30 p-2 rounded-lg text-xs flex justify-between items-center relative overflow-hidden">
                    ...
                    <span className="text-[10px] bg-primary text-white px-1.5 py-0.5 rounded z-10 font-bold">85%</span>
                  </div>
                  <div className="bg-zinc-900 border border-zinc-800 p-2 rounded-lg text-xs flex justify-between items-center opacity-40">
                    <span className="font-medium text-zinc-500">Proposal</span>
                    <span className="text-[10px] bg-zinc-800 px-1.5 py-0.5 rounded text-zinc-500">0%</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="py-20 bg-zinc-950 border-t border-zinc-900 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="p-6 border border-zinc-800 rounded-xl bg-zinc-900/30 hover:border-primary/50 transition-all group">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-5 text-primary group-hover:bg-primary group-hover:text-black transition-colors">
      ...
      {/* Workflow Diagram */}
      <section id="workflow" className="py-20 bg-black border-t border-zinc-900 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 relative">
            ...
            {/* Step 1 */}
            <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-900/30 text-center relative">
              <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-primary text-black text-xs font-bold w-7 h-7 rounded-full flex items-center justify-center">1</span>
              <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center mx-auto mb-4 text-primary">
                <Users2 className="w-5 h-5" />
              </div>
              <h4 className="font-bold text-sm">Lead Form Submitted</h4>
              <p className="text-xs text-zinc-500 mt-2">Lead submits form on Meta Ad, Google search page, or landing site.</p>
            </div>

            {/* Step 2 */}
            <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-900/30 text-center relative">
              <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-primary text-black text-xs font-bold w-7 h-7 rounded-full flex items-center justify-center">2</span>
              <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center mx-auto mb-4 text-primary">
                <MessageSquare className="w-5 h-5" />
              </div>
              <h4 className="font-bold text-sm">Instant WhatsApp Engaged</h4>
              <p className="text-xs text-zinc-500 mt-2">Within 15 seconds, our system triggers welcome & screen questions.</p>
            </div>

            {/* Step 3 */}
            <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-900/30 text-center relative">
              <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-primary text-black text-xs font-bold w-7 h-7 rounded-full flex items-center justify-center">3</span>
              <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center mx-auto mb-4 text-primary">
                <Zap className="w-5 h-5" />
              </div>
              <h4 className="font-bold text-sm">AI Score Calculation</h4>
              <p className="text-xs text-zinc-500 mt-2">AI parses customer details, calculates scoring thresholds, and flags fit status.</p>
            </div>

            {/* Step 4 */}
            <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-900/30 text-center relative">
              <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-primary text-black text-xs font-bold w-7 h-7 rounded-full flex items-center justify-center">4</span>
              <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center mx-auto mb-4 text-primary">
                <Check className="w-5 h-5" />
              </div>
              <h4 className="font-bold text-sm">Owner Pipeline Auto-Sync</h4>
              <p className="text-xs text-zinc-500 mt-2">Qualified items are added to CRM pipeline, prompting agent for high-value follow-ups.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="py-20 bg-zinc-950 border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Plan 1 */}
            <div className="border border-zinc-800 rounded-xl p-8 bg-zinc-900/20 backdrop-blur flex flex-col justify-between">
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-zinc-400 block mb-2">Starter</span>
                <span className="text-3xl font-bold">$49<span className="text-xs text-zinc-500 font-normal">/month</span></span>
                <p className="text-xs text-zinc-500 mt-2">Ideal for sole proprietorships starting automation.</p>
              ...
              <Link 
                href="/register" 
                className="mt-8 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 text-white font-medium py-2 rounded-lg text-center text-xs transition-colors"
              >
                Choose Starter
              </Link>
            </div>
            ...
            {/* Plan 2 */}
            <div className="border-2 border-primary rounded-xl p-8 bg-zinc-900/40 backdrop-blur flex flex-col justify-between relative shadow-2xl shadow-primary/10">
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-black text-[10px] font-extrabold uppercase px-3 py-1 rounded-full">Most Popular</span>
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-primary block mb-2">Professional</span>
                <span className="text-3xl font-bold">$129<span className="text-xs text-zinc-500 font-normal">/month</span></span>
                <p className="text-xs text-zinc-500 mt-2">Perfect for growing sales departments needing rich CRM details.</p>
                <div className="border-t border-zinc-800 my-6" />
              ...
              <Link 
                href="/register" 
                className="mt-8 bg-primary hover:bg-primary/95 text-white font-semibold py-2 rounded-lg text-center text-xs transition-colors shadow-lg shadow-primary/10"
              >
                Choose Professional
              </Link>
            </div>
            ...
            <div className="border border-zinc-800 rounded-xl p-8 bg-zinc-900/20 backdrop-blur flex flex-col justify-between">
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-zinc-400 block mb-2">Enterprise</span>
                <span className="text-3xl font-bold">$399<span className="text-xs text-zinc-500 font-normal">/month</span></span>
                <p className="text-xs text-zinc-500 mt-2">Tailored for large firms demanding high volumes and uptime SLA.</p>
                <div className="border-t border-zinc-800 my-6" />
                <ul className="space-y-3.5 text-xs text-zinc-400">
                  <li className="flex items-center gap-2.5">
                    <Check className="w-4 h-4 text-primary shrink-0" />
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-20 bg-black border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-900/20">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-zinc-500">Director of Sales, Apex Realty</span>
                </div>
              </div>
            </div>
            ...
            <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-900/20">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-zinc-500">Founder, ScaleMedia Agency</span>
                </div>
              </div>
            </div>
            ...
            <div className="border border-zinc-800 rounded-xl p-6 bg-zinc-900/20">
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-zinc-500">Operations Manager, EduGrowth Inc</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-zinc-900 bg-zinc-950 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-zinc-500">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded bg-primary flex items-center justify-center text-[10px] text-white font-bold">WA</div>
            <span className="font-semibold text-white">WACRM SaaS Portal</span>
          </div>
      ...
      {showDemoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
          <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-6 max-w-sm w-full relative animate-fade-in">
            ...
            <p className="text-xs text-zinc-400 mt-1">Select a comfortable slot for a live walk-through with our team.</p>

            <form onSubmit={handleBookDemo} className="mt-4 space-y-4">
              <div>
                <label className="text-[10px] uppercase font-bold text-zinc-400 block mb-1">Your Name</label>
                <input 
                  type="text" 
                  required
                  value={demoForm.name}
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded px-3 py-2 text-xs text-white focus:outline-none focus:border-primary"
                />
              </div>
              <div>
                <label className="text-[10px] uppercase font-bold text-zinc-400 block mb-1">Business Email</label>
                <input 
                  type="email" 
                  required
              ...
              <div>
                <label className="text-[10px] uppercase font-bold text-zinc-400 block mb-1">Select Date</label>
                <input 
                  type="date" 
                  required
                  value={demoForm.date}
              ...
              <button
                type="submit"
                disabled={demoBooked}
                className="w-full bg-primary hover:bg-primary/95 text-white font-semibold py-2 rounded text-xs transition-colors flex items-center justify-center"
              >
