...
export class WebhooksController {
  static async metaWebhook(req: Request, res: Response, next: NextFunction) {
    try {
      const organizationId = req.params.orgId as string; // Passed in URL
  ...
  static async googleWebhook(req: Request, res: Response, next: NextFunction) {
    try {
