...
export class UsersService {
  ...
  static async inviteUser(organizationId: string, data: any) {
  ...
  static async updateUser(organizationId: string, userId: string, data: any) {
  ...
  static async deactivateUser(organizationId: string, userId: string) {
    return prisma.user.update({
      where: { id: userId, organizationId },
