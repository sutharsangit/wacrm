...
export default function CrmKanban() {
  const { leads, fetchLeads, updateLeadStatus, deleteLead } = useLeadsStore();
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-6">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-zinc-900 border border-zinc-800 rounded-lg text-xs text-white focus:outline-none focus:border-primary"
          />
        </div>
      </div>
              ...
              >
                ...
                <div className="flex items-center justify-between pb-3 mb-3 border-b border-border/60">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] bg-secondary px-2 py-0.5 rounded-full font-bold text-zinc-400">
                      {stageLeads.length}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto space-y-2.5 pr-1">
                  {stageLeads.length > 0 ? (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-start justify-between">
                            <span className="px-2 py-0.5 rounded text-[9px] font-bold bg-secondary border border-border text-zinc-400">
                              {lead.source}
                            </span>
                          ...
                          {/* Lead Name */}
                          <div>
                            <span className="font-bold text-xs text-white block group-hover:text-primary transition-colors">
                              {lead.name}
                            </span>
                          ...
                          <div className="flex items-center justify-between border-t border-border/40 pt-2.5 text-[9px] text-muted-foreground font-mono">
                            ...
                            <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                              <Link 
                                ...
                                className="p-1 hover:bg-secondary rounded text-zinc-400 hover:text-white"
                    ...
                    <div className="h-full flex items-center justify-center border-2 border-dashed border-zinc-900 rounded-xl py-12 text-center">
                      <div className="max-w-[180px] space-y-1 text-zinc-600">
