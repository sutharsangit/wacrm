      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-6">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="border border-border bg-zinc-900/60 hover:bg-zinc-900 text-zinc-300 font-semibold px-4 py-2 rounded-lg text-xs flex items-center gap-1.5 transition-colors"
          >
              ...
              <tbody className="divide-y divide-border/60">
                {mockTeamPerformance.map((item, idx) => (
                  <tr key={idx} className="hover:bg-secondary/15 transition-colors">
                    ...
                    <td className="p-3 text-center text-zinc-300">{item.leadsAssigned}</td>
                    <td className="p-3 text-center text-zinc-300">{item.qualifiedCount}</td>
                    <td className="p-3 text-center">
                      <div className="flex items-center justify-center gap-2">
                        <span className="font-bold text-white">{item.conversionRate}%</span>
