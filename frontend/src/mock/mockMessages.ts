...
export interface MessageTemplate {
  id: string;
  name: string;
  category: 'Qualification' | 'Follow-up' | 'Marketing' | 'Support';
  body: string;
}
...
export const mockTemplates: MessageTemplate[] = [
  ...
  },
  {
    ...
    category: 'Marketing',
    body: 'Exciting news {{name}}! We just launched our AI Auto-Qualification Engine v2. Users are reporting a 40% reduction in lead response times. Click here to learn more: https://wacrm.io/ai'
  }
];
